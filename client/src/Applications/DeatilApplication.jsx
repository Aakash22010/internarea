...
useEffect(()=>{
  ...
  const response=await axios.get(`https://internarea-p1go.onrender.com/api/application/${id}`)
...
const handleAcceptAndReject= async(id,action)=>{
  try {
    const response=await axios.put(`https://internarea-p1go.onrender.com/api/application/${id}`,{action})
      ...
      <div class="container px-5 py-24 mx-auto">
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <h1 class="text-gray-900 font-bold title-font mb-1 -mt-8">{`aakashOrg Ltd.`}</h1>
          <h2>Cover Letter</h2>
